    ...
    : PagedQueryHandler<GetCountriesQuery, CountryDTO>
{
    ...
    protected override async Task<(List<CountryDTO> Items, int TotalCount, string? NextCursor)> FetchAsync(GetCountriesQuery request, CancellationToken cancellationToken)
    {
