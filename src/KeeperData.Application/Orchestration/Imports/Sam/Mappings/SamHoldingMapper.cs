...
public static class SamHoldingMapper
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var (premiseActivityTypeId, premiseActivityTypeName) = premiseActivityTypeCode != null ? await resolvePremiseActivityType(premiseActivityTypeCode, cancellationToken) : (null, null);
        var (premiseTypeId, premiseTypeName) = premiseTypeCode != null ? await resolvePremiseType(premiseTypeCode, cancellationToken) : (null, null);
