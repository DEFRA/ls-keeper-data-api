...
public class SamPartyDailyScanStep(
    ...
    : DailyScanStepBase<SamDailyScanContext, SamScanPartyIdentifier>(dataBridgeClient, intakeMessagePublisher, dataBridgeScanConfiguration, delayProvider, configuration, logger)
{
