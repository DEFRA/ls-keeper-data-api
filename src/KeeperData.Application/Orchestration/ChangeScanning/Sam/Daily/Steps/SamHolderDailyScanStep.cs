...
public class SamHolderDailyScanStep(
    ...
    : DailyScanStepBase<SamDailyScanContext, SamScanHolderIdentifier>(dataBridgeClient, intakeMessagePublisher, dataBridgeScanConfiguration, delayProvider, configuration, logger)
{
