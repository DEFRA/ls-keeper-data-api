...
public class TaskScanCTSBulkFiles(
    ILogger<TaskScanCTSBulkFiles> logger,
    IDistributedLock distributedLock,
    IHostApplicationLifetime applicationLifetime) : ITaskScanCTSBulkFiles
{
    private const string LockName = nameof(TaskScanCTSBulkFiles);
