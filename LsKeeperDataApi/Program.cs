using LsKeeperDataApi.Example.Endpoints;
using LsKeeperDataApi.Example.Services;
using LsKeeperDataApi.Utils;
using LsKeeperDataApi.Utils.Http;
using LsKeeperDataApi.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LsKeeperDataApi.Config;
using LsKeeperDataApi.Utils.Logging;
using Serilog;
