    ...
    ApiContainerFixture apiContainerFixture) : IAsyncLifetime
{
    ...
    [InlineData("WhenSearchingByMultipleIdentifiers", null, null, "CPHN", null, 2, SiteBId + "," + SiteCId)]
    [InlineData("WhenSearchingByMultipleIdentifiersWithSpaces", null, null, " CPHN ", null, 2, SiteBId + "," + SiteCId)]
