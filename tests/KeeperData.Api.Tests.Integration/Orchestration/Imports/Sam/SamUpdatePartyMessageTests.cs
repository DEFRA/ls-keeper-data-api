...
public class SamUpdatePartyMessageTests(MongoDbFixture mongoDbFixture, LocalStackFixture localStackFixture, ApiContainerFixture apiContainerFixture)
{
    ...
    [Fact]
    public async Task GivenSamUpdatePartyMessagePublishedToQueue_WhenReceived_ShouldBeHandled()
    {
        var correlationId = Guid.NewGuid().ToString();
        var message = new SamUpdatePartyMessage { Identifier = "PARTY999" };
