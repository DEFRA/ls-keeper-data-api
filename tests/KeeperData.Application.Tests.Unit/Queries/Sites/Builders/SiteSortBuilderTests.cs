...
public class SiteSortBuilderTests
{
    ...
    [Theory]
    [InlineData("name", "asc", "{ \"name\" : 1, \"_id\" : 1 }")]
    [InlineData("name", "desc", "{ \"name\" : -1, \"_id\" : -1 }")]
    [InlineData("name", null, "{ \"name\" : 1, \"_id\" : 1 }")]
    [InlineData("type", "asc", "{ \"type.code\" : 1, \"_id\" : 1 }")]
    [InlineData("type", "desc", "{ \"type.code\" : -1, \"_id\" : -1 }")]
    [InlineData("type", null, "{ \"type.code\" : 1, \"_id\" : 1 }")]
    [InlineData("siteidentifier", "asc", "{ \"identifiers.identifier\" : 1, \"_id\" : 1 }")]
    [InlineData("siteidentifier", "desc", "{ \"identifiers.identifier\" : -1, \"_id\" : -1 }")]
    [InlineData("siteidentifier", null, "{ \"identifiers.identifier\" : 1, \"_id\" : 1 }")]
    [InlineData(null, null, "{ \"name\" : 1, \"_id\" : 1 }")]
